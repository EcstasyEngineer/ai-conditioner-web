...
- No permanence vocabulary at all in these tiers (forever, permanent, permanently,
  never again, for good, irreversible, can never) - it is legal only at extreme tier and
  these batches are basic/light/moderate.
...
BAD_WORDS = re.compile(
    r"\b(delve|tapestry|symphony|journey|beacon|vessel|forever|permanent|permanently|"
    r"irreversible|healing|anxiety)\b",
    re.I,
)
